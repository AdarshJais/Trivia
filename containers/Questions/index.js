...
const DATA = [
  ...
  },
  {
    ...
    image: require("../../assets/spongebob.png"),
    options: [
      "A    Patrik Star",
      "B    Potato Head",
      "C    Olaf",
  ...
  },
  {
    ...
    image: require("../../assets/pixar.jpg"),
    options: [
      "A    The Bug's Life",
      "B    Monster Inc.",
      "C    Radhe",
  ...
  },
  {
    ...
    image: require("../../assets/elsaandanna.jpg"),
    options: [
      "A    Winterfall",
      "B    Arendelle",
      "C    Emmerdale",
  ...
  {
    title: "Question 6 / 10",
    question: "What is Simba’s childhood best friend called in the Lion King?",
    image: require("../../assets/simbha.png"),
  ...
  },
  {
    ...
    image: require("../../assets/woodyandbuzz.jpg"),
    options: [
      "A    Quack and Jumpy",
      "B    Flappy and Furry",
      "C    Ducky and Bunny",
  ...
  },
  {
    ...
    image: require("../../assets/wallace.jpg"),
  ...
  },
  {
    ...
    image: require("../../assets/scoobydoo.jpg"),
    options: [
      "A    Cow and Chicken",
      "B    Scooby-Doo",
      "C    Johny Bravo",
